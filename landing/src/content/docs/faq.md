...
Email [gitwarden.support@gmail.com](mailto:gitwarden.support@gmail.com) or open an issue on the [GitWarden releases repository](https://github.com/shchadyloTaras/gitwarden-releases/issues). Include your OS, the GitWarden version (shown in the app footer), what you expected to happen, and what actually happened.
