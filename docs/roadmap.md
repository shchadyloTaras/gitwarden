...
> **Direction, not a promise.** Near-term items are firm; the further out, the more they will change. This is an outcome-level portfolio view, not a release plan — no dates. The *how* lives in each feature's spec/plan, linked below; this file holds the *why*.
>
...
| ----------------- | ----- | ------ | ---------- | ----------- | ---- |
| Warn on *implausible* repo↔profile bindings (an org-named remote bound to a personal profile) so a mis-binding can't yield a confidently-wrong verdict | 7 | 2 | 80% | 1 | **11.2** |
