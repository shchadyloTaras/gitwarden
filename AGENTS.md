...
- **History Commit Details:** `docs/plans/history-commit-details-plan.md` + `docs/prompts/history-commit-details-prompts.md`
- **Unified Commit & Remote:** `docs/plans/unified-commit-remote-plan.md` + `docs/prompts/unified-commit-remote-prompts.md`
- **Profile Repository Summary:** `docs/plans/profile-repository-summary-plan.md` + `docs/prompts/profile-repository-summary-prompts.md`
...
- **Private-Source Distribution:** `docs/plans/private-source-distribution-plan.md` + `docs/prompts/private-source-distribution-prompts.md`
- **Uncommit to Working Changes:** `docs/plans/uncommit-to-changes-plan.md` + `docs/prompts/uncommit-to-changes-prompts.md`
- **Sidebar Update Button:** `docs/plans/sidebar-update-button-plan.md` + `docs/prompts/sidebar-update-button-prompts.md`
- **Connect-Return Check:** `docs/plans/connect-return-check-plan.md` + `docs/prompts/connect-return-check-prompts.md`
- **Merge a Branch:** `docs/plans/merge-branch-plan.md` + `docs/prompts/merge-branch-prompts.md`
- **Initialize Repository:** `docs/plans/initialize-repository-plan.md` + `docs/prompts/initialize-repository-prompts.md`
- **Branch-Switch Data Integrity:** `docs/plans/branch-switch-integrity-plan.md` + `docs/prompts/branch-switch-integrity-prompts.md`
- **QA Fixes:** `docs/plans/qa-fixes-plan.md` + `docs/prompts/qa-fixes-prompts.md`
- **Working-Copy Destination:** `docs/plans/working-copy-destination-plan.md` + `docs/prompts/working-copy-destination-prompts.md`
