...
export const STR = {
  ...
  // ── Change Review Assistant (Phase 33) ─────────────────────────────────────
  CHANGE_REVIEW_TITLE: 'Review staged changes',
  CHANGE_REVIEW_HINT:
    'Deterministic checks run without AI. Secret-like content blocks commit until removed.',
  CHANGE_REVIEW_SCANNING: 'Scanning staged changes…',
  CHANGE_REVIEW_AI_BUTTON: 'Run AI review',
  CHANGE_REVIEW_AI_LOADING: 'Reviewing…',
  CHANGE_REVIEW_AI_PREVIEW_REQUIRED: 'Show what will be sent before running AI review.',
  CHANGE_REVIEW_ERROR: 'Could not complete the change review.',
  CHANGE_REVIEW_SCAN_ERROR: 'Could not scan staged changes.',
  CHANGE_REVIEW_NO_FINDINGS: 'No issues detected in staged changes.',
  CHANGE_REVIEW_OVERALL: 'Overall',
  CHANGE_REVIEW_SOURCE_DETERMINISTIC: 'Deterministic',
  CHANGE_REVIEW_SOURCE_AI: 'AI',
  CHANGE_REVIEW_CONFIDENCE: (level: string) => `Confidence: ${level}`,
  CHANGE_REVIEW_WHY: 'Why this matters',
  CHANGE_REVIEW_CATEGORY_SECRET: 'Secret-like changes',
  CHANGE_REVIEW_CATEGORY_RISKY: 'Risky files',
  CHANGE_REVIEW_CATEGORY_MIGRATION: 'Migrations',
  CHANGE_REVIEW_CATEGORY_LOCKFILE: 'Lockfiles',
  CHANGE_REVIEW_CATEGORY_GENERATED: 'Generated files',
  CHANGE_REVIEW_CATEGORY_MISSING_TESTS: 'Missing tests',
  CHANGE_REVIEW_CATEGORY_DESTRUCTIVE: 'Destructive changes',
  ...
  AI_TEMPLATE_EXPORT: 'Export template',
  AI_TEMPLATE_IMPORT: 'Import template',
  AI_TEMPLATE_DUPLICATE: 'Duplicate connection',
  AI_TEMPLATE_EXPORTED: 'Template copied to clipboard.',
  AI_TEMPLATE_IMPORT_SUCCESS: 'Template imported — add a credential before enabling.',
  AI_TEMPLATE_IMPORT_ERROR: 'Could not import the template.',
  AI_TEMPLATE_EXPORT_ERROR: 'Could not export the template.',
  AI_TEMPLATE_BUILTIN: 'Built-in templates',
  AI_REPO_RECOMMENDED_CONNECTION: 'Recommended AI connection for this repo',
